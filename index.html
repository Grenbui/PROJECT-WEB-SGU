    ...
    <div id="main">
        ...
        <div id="home-gallery">
            <div class="container">
                ...
                <div class="hg-content">
                    <a onclick="closeHgModalYoutube()" id="hgModalYoutube" class="open-youtube">
        ...
        <div id="modalYoutube">
            <div class="hg-modal-content">
                <span class="hg-modal-close">
                    <i class="fa-solid fa-xmark"></i>
                </span>
                <div class="hg-modal-body">
                    <div class="video-wrapper">
                        <iframe id="home-video-player" width="100%" height="100%" src="https://www.youtube.com/embed/IrjeG5HKB9A" frameborder="0" allowfullscreen=""></iframe>
                    </div>
                </div>
            </div>
        </div>
