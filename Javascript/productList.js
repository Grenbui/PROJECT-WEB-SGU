var ListOfProduct = [
    ...
    {
        id: 12,
        productName: 'Flip-flop weaving (black)',
        productPrice: '3,050,000đ',
        productImage: './Image/Flip-flop/black1.jpg',
        productType: 'Flip-flop',
    },

    {
        id: 13,
        productName: 'Flip-flop weaving (blue)',
        productPrice: '3,050,000đ',
        productImage: './Image/Flip-flop/blue1.jpg',
        productType: 'Flip-flop',
    },
    
    {
        id: 14,
        productName: 'Flip-flop weaving (brown)',
        productPrice: '3,050,000đ',
        productImage: './Image/Flip-flop/brown2.jpg',
        productType: 'Flip-flop',
    },

    {
        id: 15,
        productName: 'Flip-flop weaving (grey)',
        productPrice: '3,050,000đ',
        productImage: './Image/Flip-flop/grey2.jpg',
        productType: 'Flip-flop',
    },

    {
        id: 16,
        productName: 'Flip-flop weaving (red)',
        productPrice: '3,050,000đ',
        productImage: './Image/Flip-flop/red2.jpg',
        productType: 'Flip-flop',
    },
...
function renderProd(ListOfProduct){
    var firstpage =ListOfProduct.map(function(product1)
    {
            ...
            return  `
                        <div class="body__product col-lg-3" data-aos="fade-up">
                            <div class="product__detail">
                                <div class="body__product-img-content">
                                    <a href="#">
                                        <img src="${product1.productImage}" alt="Product image" class="body__product-img">
                                    </a>
                                </div>
                
                                <div class="body__product-text">
                                    <a href='#' class="text__link">
                                        <h2 class="body__product-name">${product1. productName}</h2>
                                    </a>
                                    <h3 class="body__product-price">${product1.productPrice}</h3>
                                </div>
                            </div>
                        </div>
    ...
    prodList.innerHTML = firstpage.join('');
}

document.addEventListener("DOMContentLoaded", function() {
    renderProd(ListOfProduct);
});
